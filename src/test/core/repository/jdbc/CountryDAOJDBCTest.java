...
import core.repository.country.CountryDAO;
...
public class CountryDAOJDBCTest extends DAOTestTemplate {
    ...
    public void testFindByName() throws Exception {
        Country expectedCountry = new Country(1, "Ukraine");
    ...
    public void testFindAll() throws Exception {
        Country countryFirst = new Country(1, "Ukraine");
        Country countrySecond = new Country(2, "USA");
